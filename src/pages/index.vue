...
import { ImageBlock, PerfectShotSection, TableImagesBlock, TwoColTextAndImageBlock, VideoBlock } from '@/widgets/media-blocks';
...
<template>
  ...
  <div class="flex flex-col gap-12 md:gap-34 container mx-auto px-3">
    <Gallery class="mt-8" />
    <ImageBlock title="Best platform for your perfect Headshots" url="/images/preview-photo-ai.webp" />
  ...
  <div class="flex flex-col gap-12 md:gap-34 container mx-auto px-3">
    <TableImagesBlock />
    <VideoBlock title="Create video clips with AI" subtitle="Take any AI photo you generated, and turn it into a video by tapping [ Make video ]. A few minutes later you have a short video clip of the photo giving you an immersive virtual reality like experience." url="/create-video.mp4" />
    <FAQSection
